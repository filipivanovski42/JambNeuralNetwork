"""
Evaluate JAX Jamb Agent - 100k Games (V2 PPO_4)
=========================================
Runs 100,000 games on GPU to gather comprehensive statistics.
Focus on 'jamb_jax_v2' model (PPO_4).
"""
...
# ─── Configuration ───────────────────────────────────────────────────
TOTAL_GAMES = 100_000
BATCH_SIZE = 5_000 # Use 5000 to be safe
MODEL_DIR = "models/jamb_jax_v2" 
REPORT_FILENAME = "jamb_v2_ppo4_100k_report.md"
REPORT_TITLE = "Jamb Agent (V2 PPO_4) Evaluation Report"
